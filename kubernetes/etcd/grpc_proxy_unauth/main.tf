resource "alicloud_instance" "instance" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      "setsid /usr/local/bin/etcd grpc-proxy start --cert /root/server.crt --key /root/server.key --cacert /root/ca.crt --endpoints=0.0.0.0:2379 --insecure-skip-tls-verify --advertise-client-url 0.0.0.0:23790 --listen-addr 0.0.0.0:23790 2>&1 1>/tmp/nohup &"
    ]
  }
